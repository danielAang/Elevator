...
public class ElevatorControllerCLook {
	...
	public ElevatorControllerCLook(Elevator elevator, Integer totalFloors) {
		super();
	 ...
	 */
	public void move() {
		getElevator().printInformation("The elevator is at the " + getElevator().getCurrentPosition() + " floor");
